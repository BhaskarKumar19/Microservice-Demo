...
/**
 * Filter responsible to check if there is any authorization token in the
 * request, if found then validate the token and add a
 * "UsernamePasswordAuthenticationToken" in the header. If no token found in
 * header then simply delegate the request to other filer in filter chain.
 */
